...
String City = get.getCity();
PreparedStatement pstmt=con.prepareStatement("select * from blackspot where City=?");
...
<td><a href="DeleteBlackSpot.jsp?Lname=<%=rs.getString(1) %>">Delete</a></td>
</tr>
<% } %>	
</table>
 <div class="card mb-3">
                ...
                <div class="card-body">
				        ...
				        <form action="PWork.html" method="post">
                        <div class="col-12">
